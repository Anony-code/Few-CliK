...
def get_params():
    ...
    args.add_argument("-data", "--dataset", default="en_es", type=str)
    args.add_argument("-path", "--data_path", default="../../dataset/data/en_es", type=str)
    ...
    args.add_argument("-prefix", "--prefix", default="exp-en-es", type=str)
...
data_dir = {
    'train_tasks_1': '/train_tasks_1.json',
    'train_tasks_2': '/train_tasks_2.json',
    'test_tasks_2': '/test_tasks_2.json',
    'dev_tasks_1': '/dev_tasks_1.json',
    'dev_tasks_2': '/dev_tasks_2.json',

    'rel2candidates_1': '/rel2candidates_1.json',
    'rel2candidates_2': '/rel2candidates_2_all.json',
